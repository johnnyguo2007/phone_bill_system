...
class CallingPlan:
	...
	def get_local_allowance(self) -> int:
		"""
		local allowance getter
		:return: domestic allowance
		"""
		return self.allowance_domestic

	def get_international_allowance(self) -> int:
		"""
		international allowance getter
		:return: international allowance
		"""
		return self.allowance_inter

	def get_fixed_cost(self) -> float:
		"""
		fixed cost getter
		:param self:
		:return: fixed cost
...
class CallingPlans:
	...
	def add_plan(self, one_plan: CallingPlan):
		"""
		add a plan object to the internal collection(dict)
		:param one_plan: one singular plan
		:return:
		"""
	...
	def get_plan(self, plan_name: str) -> CallingPlan:
		"""
		get plan object from plans object searched by name
		:param plan_name: one string
		:return: Plan object
		"""
	...
	def load_plans_from_file(self, file_path: str):
		"""
		load data from plans file to populate the internal collection
		:param file_path: file path of plans file in string format
		:return:
		"""
